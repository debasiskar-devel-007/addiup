       ...
       <ul>
          ...
          <li><a href="<?php echo $base;?>/user/admin/mail/add">Add Admin Mail</a></li>
            ...
            <!--    <li><a class="headitem item10" href="#">Blog Manager</a>
                ...
                <li><a class="headitem item11" href="#">Ship Manager</a>
                    <ul>
                ...
                <li><a class="headitem item12" href="#">Landing Page Manager</a>
                    <ul>
                ...
                <li><a class="headitem item8" href="#">Landing Page - Product Relation</a>
                    <ul>
