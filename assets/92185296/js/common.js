...
//alert(ship);
   ...
   var type=$(obj).attr('type');
    ...
    $.post(base_url+'/product/default/savepro',{orderid:orderid,ship:ship,price:price,proid:proid,landingidid:landingidid,name:name,desc:desc,quan:quan,type:type},function(res){
      if(res==1)
      {
