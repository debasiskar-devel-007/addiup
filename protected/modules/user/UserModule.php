...
class UserModule extends CWebModule
{
    ...
    protected function registerScript(){
        $js_arr = array('common.js','link.js','common1.js','jquery.clipboard.js','jquery-scrolltofixed.js'); //put what js file name that you need to import from admin assets folder
