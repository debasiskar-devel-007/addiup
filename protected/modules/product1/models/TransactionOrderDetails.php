...
class TransactionOrderDetails extends CActiveRecord
{
    ...
    */
    public function rules()
    {
        ...
        return array(
            array('landing_product_id','required','message'=>'Please Select Any Product'),
        array('billing_fname,billing_lname,billing_add,billing_phone,billing_state,billing_city,billing_zip,shipping_fname,shipping_lname,shipping_phone,shipping_add,shipping_state,shipping_city,shipping_zip,billing_email,card_no,card_exp_mon,card_exp_year,card_cvv', 'required'),
