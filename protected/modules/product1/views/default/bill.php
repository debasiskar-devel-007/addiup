...
$res=TransactionOrderDetails::model()->findAll('transaction_id='.$tid);
...
<div class="top-header">
    ...
    <div class="inner-wrapper">
        ...
        <div class="top-logo" style="float:none; margin:0 auto;"><a href="#"><img src="<?php echo $themeUrl ?>/images/logo.png" alt="#" /></a></div>
