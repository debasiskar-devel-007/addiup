...
<div class="main-body">
    <div class="top-contain">
        ...
        <div class="top-wrapper">
            ...
            <div class="logo">   <a href="javascript:void(0)" onclick="scrolltoform()"><img src="<?php echo $themeUrl ?>/images/logo.png"  alt="#"/></a></div>
...
<div class="middle-text-contain">
    ...
    <p>AddieUP&trade; continues to receive phenomenal reviews and testimonials from customers, bloggers, doctors, students and professionals. AddieUP&trade; delivers amazing Energy and Focus supplements with attention support. We use only the highest quality ingredients in our AddieUP&trade; Pills, and offer an unconditional money back guarantee to anyone who isnt completely satisfied with our product.</p>
    ...
    <div class="video-wrapper">
        ...
        <div class="video-text-part">
            ...
            <div class="video-right-text">
                ...
                <p>
                    <strong>AddieUP&trade;</strong> provides Focus Supplements for work and school acting as the perfect study pill. AddieUP&trade; simply outperforms edgy, sugar-saturated energy drinks and shots and lasts for several hours per use. AddieUP&trade; contains stimulants, antioxidants and nootropics.<br />
                    <br />
    ...
    <div class="left-contain">
        ...
        <ul>
            <li>A proven formula with a track record of success. Our customers and independent reviews
                which are all over the internet (just google 'addieup&trade; reviews'!) can assist you if you have
                any hesitation about trying AddieUP&trade; Mental Focus Supplements.</li>
            ...
            <li>AddieUP&trade; Energy and Focus supplements are manufactured in the US, at a GMP (Good
