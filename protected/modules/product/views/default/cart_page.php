...
$arrmonth=array(''=>'Month','01'=>'January','02'=>'February','03'=>'March','04'=>'April','05'=>'May','06'=>'June','07'=>'July','08'=>'August','09'=>'September','10'=>'October','11'=>'November','12'=>'December');
$arryear=array(''=>'Year','2014'=>'2014','2015'=>'2015','2016'=>'2016','2017'=>'2017','2018'=>'2018','2019'=>'2019','2020'=>'2020','2021'=>'2021','2022'=>'2022','2023'=>'2023','2024'=>'2024');
?>
<style type="text/css">
    .thumbnails{
...
<script type="application/javascript">
    ...
    if($("#horizontalForm").find('input.error').length >0){
        ...
        if($("#horizontalForm").find('input[type="hidden"].error').length >0){
            ...
            $('html, body').animate({ scrollTop: $("#TransactionOrderDetails_shipping_fname").eq(0).offset().top-100 }, 500);
        }
    }else{
        $('html, body').animate({ scrollTop: $(".product_chk").eq(0).offset().top-100 }, 500);
    }
...
<div class="top-header">
    ...
    <div class="inner-wrapper">
        ...
        <div class="top-logo"><a href="javascript:void(0)"><img src="<?php echo $themeUrl ?>/images/logo.png" alt="#" /></a></div>
...
<div class="order-form-contain">
    ...
    <div class="spanerr">
    <span style="color: #ff0000;display:inline-block;" id="errrrrr" class="error"></span>

    <span style="display: none;background: #e67716;padding:5px;
border-radius: 5px;" id="gopro" class="error"><a href="javascript:void(0)" style="color: #fff;" onclick="selectpro()" id="gopro"  class="buynow">Choose Product</a></span>
</div>
    <div class="clear"></div>
    ...
    <img style="margin-left:-4px;height:22px" src="<?php echo $themeUrl;?>/images/1411083292_amex.png" alt="#" class="visaimg"  />
    ...
    <div style="margin-left: 10px;">
        <?php echo $form->dropDownListRow(
            $model,
            'card_exp_mon',$arrmonth, array('class'=>"input3")
        ); ?>
  <!--      --><?php /*echo $form->textFieldRow(
            $model,
        ...
        <?php echo $form->dropDownListRow(
            $model,
            'card_exp_year',$arryear, array('class'=>"input4")
        ); ?>
  <!--      --><?php /*echo $form->textFieldRow(
            $model,
