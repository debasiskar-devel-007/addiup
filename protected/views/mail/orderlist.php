    ...
    <tr>
        <td align="center">
            <table width="600" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:14px;">
                <tr>
                    <td colspan="2" align="center" valign="middle" style=" background:#fff9fc; border-bottom:solid 2px #e67716; padding:10px 0;"><a href="http://goaddieup.com/"><img src="http://goaddieup.com/themes/front/images/logo.png"  width="180" alt="#"/></a></td>
                </tr>

                <tr>
                    <td style="border-top:solid 2px #e67716; width:48%; padding:15px 0 0 2%;" align="left">
                        <strong style="font-size:26px; color:#669900; font-weight:normal; font-style:italic;"></strong><br />

                        <span style="font-size:14px; color:#e67716;"></span>
                    </td>
                    <td style="border-top:solid 2px #e67716; width:48%; padding:15px 2% 0 0; font-size:14px; color:#363636; line-height:25px;" align="right">
                ...
                <tr>
                    <td style=" width:48%; padding:25px 0 0 2%;" align="left" valign="top">
                        <span style="background:#e67716; width:89%; padding:8px 0 7px 5%;  font-size:18px; color:#fff; display:block;">Bill To</span>

                    </td>
                    <td style=" width:48%; padding:25px 2% 0 0;" align="right" >

                        <span style="background:#e67716; width:89%; padding:8px 0 7px 5%;  font-size:18px; color:#fff; text-align:left; display:block;">Ship To</span>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2" align="center" valign="middle">
                        ...
                        <table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin:5px 0; border:solid 1px #c6c6c6; border-bottom:none; font-size:13px;">
                            <tr>
                                <th width="9%"  align="left" valign="middle" style="background:#e67716; color:#fff; font-size:14px; padding:5px 2%;">Item</th>
                                <th   width="10%" align="left" valign="middle"  style="background:#e67716; color:#fff; font-size:14px; padding:5px 2%;">Quantity </th>
                                <th  width="29%" align="middle" valign="middle"  style="background:#e67716; color:#fff; font-size:14px; padding:5px 2%;">Name</th>
                                <th  width="37%" align="right" valign="middle"  style="background:#e67716; color:#fff; font-size:14px; padding:5px 2%;">Amount</th>
                                <th  width="15%" align="right" valign="middle"  style="background:#e67716; color:#fff; font-size:14px; padding:5px 2%;">Autoship</th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td  width="10%" style="border-bottom:solid 1px #c6c6c6;  padding:8px 2%;" align="left" valign="middle" >&nbsp;</td>
                                <td  width="29%" style="border-bottom:solid 1px #c6c6c6;  padding:8px 2%;" align="left" valign="middle" >&nbsp; </td>
                                <td  width="37% " style="border-bottom:solid 1px #c6c6c6;  padding:8px 2%;" align="right" valign="middle"> <span style="display:inline-block; padding-right:5px; text-align:right; width:76px;">Shipping</span>          <span style="display:inline-block; text-align:right;  width:76px;">$<?php echo $order_ship_bill_details['shiping_charge'];?></span></td>
                                <td  width="15%" style="border-bottom:solid 1px #c6c6c6;  padding:8px 2%;" align="left" valign="middle" >&nbsp; </td>
                            </tr>
                ...
                <tr>
                    <td colspan="2" align="center" valign="middle"><a href="http://goaddieup.com/" style="background:#e67716; display:inline-block; color:#fff; font-size:16px; font-weight:bold; padding:15px 18px; margin:20px auto; text-decoration:none; border: solid 2px #e67716;">Continue Shopping</a></td>
                </tr>

                <tr>
                    <td colspan="2" align="center" valign="middle" style="font-size:12px; color:#fff; text-align:center; background:#e67716; padding:25px 10px;">Copyright 2014 © AddieUP™. All rights reserved.</td>
                </tr>
